...
class RegistrationClass{
    async Registration(req,res){
         await service.UserRegistration(req.body,res)//body content
          .then((result)=>{
    ...
    async loginControll(req,res){
        await service.loginServices(req.body,res)
       .then((result)=>{
     ...
     async frgtpssControl(req,res){
          await service.frgtpassService(req.body,res)
          .then((result)=>{
     ...
     async rstpassControl(req,res){
       await   service.rstpassService(req.body,res)
          .then((result)=>{
               console.log(result)
               res.send(JSON.stringify(result))
          })
